...
import { useLOCRates } from './care-levels/useLOCRates';
import InfoBox from './care-levels/components/InfoBox';
import LOCRateTable from './care-levels/components/LOCRateTable';

export const CareLevelTab: React.FC = () => {
  const {
    rates,
    loading,
    editingId,
